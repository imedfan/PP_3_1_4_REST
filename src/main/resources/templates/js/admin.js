...
const addCar = document.getElementById('car1')
...
on(document, 'click', '#edit-user', e => {
    ...
    document.getElementById('car2').value = userInfo.children[2].innerHTML
...
on(document, 'click', '#delete-user', e => {
    ...
    document.getElementById('car3').value = fila2.children[2].innerHTML
